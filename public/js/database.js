...
class DatabaseManager {
    ...
    async rebuildViews() {
        console.log('Manually rebuilding views...');
        this.createOrUpdateViews();
        await this.saveDatabaseToFile();
        console.log('Views rebuilt and database saved successfully. Reload the page to see changes.');
    }
    ...
    createOrUpdateViews() {
        try {
            ...
            // Create view that combines shots with corrections and calculates garbage time
