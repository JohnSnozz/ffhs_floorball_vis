// WORKING AUTH SERVER - NO REDIRECT LOOPS
...
Bun.serve({
    ...
    async fetch(req) {
        ...
        // IMPORTANT: Serve all files directly without auth checks for now
        // This prevents redirect loops

        // Block old index.html
